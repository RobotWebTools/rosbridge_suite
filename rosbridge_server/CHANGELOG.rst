...
2.7.1 (2026-08-12)
------------------
* fix: Prevent event loop starvation by adding a write queue (backport `#1290 <https://github.com/RobotWebTools/rosbridge_suite/issues/1290>`_) (`#1294 <https://github.com/RobotWebTools/rosbridge_suite/issues/1294>`_)
