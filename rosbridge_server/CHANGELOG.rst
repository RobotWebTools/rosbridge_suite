...
* fix: Prevent client destruction race condition (`#1183 <https://github.com/RobotWebTools/rosbridge_suite/issues/1183>`_)
* fix: Race condition in websocket test (`#1185 <https://github.com/RobotWebTools/rosbridge_suite/issues/1185>`_)
...
* feat: Add timeout parameters to launch (`#1174 <https://github.com/RobotWebTools/rosbridge_suite/issues/1174>`_)
